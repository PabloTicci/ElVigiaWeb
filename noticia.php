...
<head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5119595055377524" crossorigin="anonymous"></script>
</head>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="news-container">
                    ...
                    <!-- Muestra todas las fotos asociadas a la noticia -->
                    <?php foreach ($fotos as $foto): ?>
                        <img src="<?php echo $foto ?>" alt="Imagen de la noticia" class="img-fluid rounded mb-3">
                    <?php endforeach; ?>
                    ...
                    <!-- Muestra todos los videos asociados a la noticia -->
                    <?php foreach ($videos as $video): ?>
                        <!-- Agrega tu lógica para mostrar videos (puede ser mediante etiquetas <video> o enlaces a plataformas de videos) -->
